	...
	<body>
		...
		<div id="show-car" class="content scaffold-show" role="main">
			...
			<ol class="property-list car">
				...
				<li class="fieldcontain">
					<span id="parking-label" class="property-label"><g:message code="car.parking.label" default="Parking" /></span>
				...
				<li class="fieldcontain">
					<span id="producer-label" class="property-label"><g:message code="car.producer.label" default="Producer" /></span>
					
						<span class="property-value" aria-labelledby="producer-label"><g:fieldValue bean="${carInstance}" field="producer"/></span>
