		...
		<div id="show-parking" class="content scaffold-show" role="main">
			...
			<ol class="property-list parking">
				...
				<li class="fieldcontain">
					<span id="cars-label" class="property-label"><g:message code="parking.cars.label" default="Cars" /></span>
				...
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="parking.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${parkingInstance}" field="description"/></span>
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="parking.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${parkingInstance}" field="name"/></span>
